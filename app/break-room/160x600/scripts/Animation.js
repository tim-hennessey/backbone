...
app.Animation = (function () {
	...
	function start() {
		...
		tl1.to(img1a, .75, {rotationX:"0", ease:Sine.easeOut})
		.to(img1b, 1.5, {rotationX:"0", ease:Back.easeOut}, "-=.3")

		.to(img2a, .75, {rotationX:"0", ease:Sine.easeOut}, "-=.25")
		.to(img2b, 1.5, {rotationX:"0", ease:Back.easeOut}, "-=.3");

		tl2.from(txt1, .5, {y:"+=50", ease:Sine.easeOut}, "+=2.5")
		.from(txt2, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
		.from(txt3, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
		.from(txt4, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
		.from(txt5, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
		.from(txt6, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
		.from(txt7, .5, {y:"+=50", ease:Sine.easeOut}, "-=.4")
